-- Complete RLS Optimization for Remaining Tables
...
-- Create optimized policies for remaining tables
DO $$
BEGIN
    ...
    -- Client documents: Single consolidated policy
    ...
    -- Client notes: Single consolidated policy
    ...
    -- Client activity log: Single consolidated policy
    ...
    -- Client lifecycle: Single consolidated policy
    ...
    -- Client activities: Single consolidated policy
...
CREATE INDEX IF NOT EXISTS idx_client_documents_instructor_client ON client_documents(instructor_id, client_id);
CREATE INDEX IF NOT EXISTS idx_client_notes_instructor_client ON client_notes(instructor_id, client_id);
CREATE INDEX IF NOT EXISTS idx_payments_user_id ON payments(user_id);
CREATE INDEX IF NOT EXISTS idx_manual_credits_user_id ON manual_credits(user_id);
CREATE INDEX IF NOT EXISTS idx_client_activity_log_instructor_client ON client_activity_log(instructor_id, client_id);
CREATE INDEX IF NOT EXISTS idx_client_lifecycle_instructor_client ON client_lifecycle(instructor_id, client_id);
CREATE INDEX IF NOT EXISTS idx_notifications_user_id ON notifications(user_id);
CREATE INDEX IF NOT EXISTS idx_client_activities_instructor_client ON client_activities(instructor_id, client_id); 